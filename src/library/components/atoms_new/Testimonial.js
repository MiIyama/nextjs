  ...
  return (
    <Box sx={{ ...props }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 3 }}>
        {image && <Image src={image} alt="Testimonial Avatar" width={imageProps.customDimension.width || 54} height={imageProps.customDimension.height || 54} style={{ borderRadius: 60, marginRight: 8 }} />}
        <Box>
